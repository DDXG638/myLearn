...
class DPromise {
    constructor(callback) {
        ...
        // 使用成员方法的话可以使用bind方法来指定this的指向，callback(this.resolve.bind(this), this.reject.bind(this))
        // let resolve = value => {
        ...
        // 捕获到错误立即reject
        try {
            callback(this.resolve.bind(this), reject)
        } catch(err) {
            reject(err)
        }
    }
...
let p1 = new DPromise((resolve, reject) => {
    setTimeout(() => {
        num > 5 ? resolve(num) : reject('num小于5')
    }, 1500)
})
